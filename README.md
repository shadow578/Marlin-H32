Note: this is the original development branch. i messed up with git tho... 
see the aquila branch for the up-to-date version (changes of this branch were incorporated into that branch in one of the first commits)
